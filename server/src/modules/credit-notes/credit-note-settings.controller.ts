...
@Controller('credit-note-settings')
@UseGuards(JwtAuthGuard, RolesGuard)
@Roles(UserRole.ADMIN)
export class CreditNoteSettingsController {
  constructor(
    @InjectRepository(CreditNoteSettings) private readonly repo: Repository<CreditNoteSettings>,
